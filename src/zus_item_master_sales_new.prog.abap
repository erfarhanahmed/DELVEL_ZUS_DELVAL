...
*&
*&---------------------------------------------------------------------*
REPORT zus_item_master_sales_new.
...
LOOP AT it_final INTO wa_final.
 ...
 wa_down-jan       =  ABS( wa_final-jan )     .
 IF wa_final-jan < 0.
    CONDENSE wa_down-jan.
    CONCATENATE '-' wa_down-jan INTO wa_down-jan.
 ENDIF.

 wa_down-feb       =  ABS( wa_final-feb )     .
 IF wa_final-feb < 0.
    CONDENSE wa_down-feb.
    CONCATENATE '-' wa_down-feb INTO wa_down-feb.
 ENDIF.

 wa_down-mar       =  ABS( wa_final-mar )      .
 IF wa_final-mar < 0.
    CONDENSE wa_down-mar.
    CONCATENATE '-' wa_down-mar INTO wa_down-mar.
 ENDIF.

 wa_down-apr       =  ABS( wa_final-apr )      .
 IF wa_final-apr < 0.
    CONDENSE wa_down-apr.
    CONCATENATE '-' wa_down-apr INTO wa_down-apr.
 ENDIF.

 wa_down-may       =  ABS( wa_final-may )     .
 IF wa_final-may < 0.
    CONDENSE wa_down-may.
    CONCATENATE '-' wa_down-may INTO wa_down-may.
 ENDIF.

 wa_down-jun       =  ABS( wa_final-jun )     .
 IF wa_final-jun < 0.
    CONDENSE wa_down-jun.
    CONCATENATE '-' wa_down-jun INTO wa_down-jun.
 ENDIF.

 wa_down-jul       =  ABS( wa_final-jul )     .
 IF wa_final-jul < 0.
    CONDENSE wa_down-jul.
    CONCATENATE '-' wa_down-jul INTO wa_down-jul.
 ENDIF.

 wa_down-aug       =  ABS( wa_final-aug )     .
 IF wa_final-aug < 0.
    CONDENSE wa_down-aug.
    CONCATENATE '-' wa_down-aug INTO wa_down-aug.
 ENDIF.

 wa_down-sep       =  ABS( wa_final-sep )      .
 IF wa_final-sep < 0.
    CONDENSE wa_down-sep.
    CONCATENATE '-' wa_down-sep INTO wa_down-sep.
 ENDIF.

 wa_down-oct       = ABS( wa_final-oct )      .
 IF wa_final-oct < 0.
    CONDENSE wa_down-oct.
    CONCATENATE '-' wa_down-oct INTO wa_down-oct.
 ENDIF.

 wa_down-nov       =  abs( wa_final-nov )     .
 IF wa_final-nov < 0.
    CONDENSE wa_down-nov.
    CONCATENATE '-' wa_down-nov INTO wa_down-nov.
 ENDIF.

 wa_down-dec          = abs( wa_final-dec )          .
 IF wa_final-dec < 0.
    CONDENSE wa_down-dec.
    CONCATENATE '-' wa_down-dec INTO wa_down-dec.
 ENDIF.
* wa_down-open_qty     =  wa_final-open_qty     .
* wa_down-un_qty       =  wa_final-un_qty       .
 wa_down-jan_pr       = abs( wa_final-jan_pr )  .
 IF wa_final-jan_pr < 0.
    CONDENSE wa_down-jan_pr.
    CONCATENATE '-' wa_down-jan_pr INTO wa_down-jan_pr.
 ENDIF.

 wa_down-feb_pr       =  abs( wa_final-feb_pr )      .
 IF wa_final-feb_pr < 0.
    CONDENSE wa_down-feb_pr.
    CONCATENATE '-' wa_down-feb_pr INTO wa_down-feb_pr.
 ENDIF.

 wa_down-mar_pr       =  abs( wa_final-mar_pr )      .
 IF wa_final-mar_pr < 0.
    CONDENSE wa_down-mar_pr.
    CONCATENATE '-' wa_down-mar_pr INTO wa_down-mar_pr.
 ENDIF.

 wa_down-apr_pr       =  abs( wa_final-apr_pr ).
 IF wa_final-apr_pr < 0.
    CONDENSE wa_down-apr_pr.
    CONCATENATE '-' wa_down-apr_pr INTO wa_down-apr_pr.
 ENDIF.

 wa_down-may_pr       =  abs( wa_final-may_pr ).
 IF wa_final-may_pr < 0.
    CONDENSE wa_down-may_pr.
    CONCATENATE '-' wa_down-may_pr INTO wa_down-may_pr.
 ENDIF.

 wa_down-jun_pr       =  abs( wa_final-jun_pr ).
 IF wa_final-jun_pr < 0.
    CONDENSE wa_down-jun_pr.
    CONCATENATE '-' wa_down-jun_pr INTO wa_down-jun_pr.
 ENDIF.

 wa_down-jul_pr       = abs( wa_final-jul_pr ).
 IF wa_final-jul_pr < 0.
    CONDENSE wa_down-jul_pr.
    CONCATENATE '-' wa_down-jul_pr INTO wa_down-jul_pr.
 ENDIF.

 wa_down-aug_pr       =  abs( wa_final-aug_pr ).
 IF wa_final-aug_pr < 0.
    CONDENSE wa_down-aug_pr.
    CONCATENATE '-' wa_down-aug_pr INTO wa_down-aug_pr.
 ENDIF.

 wa_down-sep_pr       =  abs( wa_final-sep_pr ).
 IF wa_final-sep_pr < 0.
    CONDENSE wa_down-sep_pr.
    CONCATENATE '-' wa_down-sep_pr INTO wa_down-sep_pr.
 ENDIF.

 wa_down-oct_pr       =  abs( wa_final-oct_pr ).
 IF wa_final-oct_pr < 0.
    CONDENSE wa_down-oct_pr.
    CONCATENATE '-' wa_down-oct_pr INTO wa_down-oct_pr.
 ENDIF.

 wa_down-nov_pr       =  abs( wa_final-nov_pr ).
 IF wa_final-nov_pr < 0.
    CONDENSE wa_down-nov_pr.
    CONCATENATE '-' wa_down-nov_pr INTO wa_down-nov_pr.
 ENDIF.

 wa_down-dec_pr       =  abs( wa_final-dec_pr ).
 IF wa_final-dec_pr < 0.
    CONDENSE wa_down-dec_pr.
    CONCATENATE '-' wa_down-dec_pr INTO wa_down-dec_pr.
 ENDIF.

 wa_down-pri_tot      =  abs( wa_final-pri_tot ).
 IF wa_final-pri_tot < 0.
    CONDENSE wa_down-pri_tot.
    CONCATENATE '-' wa_down-pri_tot INTO wa_down-pri_tot.
 ENDIF.

 wa_down-sale_tot     =  ABS( wa_final-sale_tot ) .
 IF wa_final-sale_tot < 0.
    CONDENSE wa_down-sale_tot.
    CONCATENATE '-' wa_down-sale_tot INTO wa_down-sale_tot.
 ENDIF.
...
*  lv_folder = 'D:\usr\sap\DEV\D00\work'.
  ...
  IF sy-subrc = 0.
DATA lv_string_1438 TYPE string.
DATA lv_crlf_1438 TYPE string.
lv_crlf_1438 = cl_abap_char_utilities=>cr_lf.
lv_string_1438 = hd_csv.
LOOP AT it_csv INTO wa_csv.
CONCATENATE lv_string_1438 lv_crlf_1438 wa_csv INTO lv_string_1438.
  CLEAR: wa_csv.
ENDLOOP.
*TRANSFER lv_string_396 TO lv_fullfile.
TRANSFER lv_string_1438 TO lv_fullfile.
...
*  lv_folder = 'D:\usr\sap\DEV\D00\work'.
  ...
  OPEN DATASET lv_fullfile
    FOR OUTPUT IN TEXT MODE ENCODING DEFAULT.  "NON-UNICODE.
  IF sy-subrc = 0.
DATA lv_string_1476 TYPE string.
DATA lv_crlf_1476 TYPE string.
lv_crlf_1476 = cl_abap_char_utilities=>cr_lf.
lv_string_1476 = hd_csv.
LOOP AT it_csv INTO wa_csv.
CONCATENATE lv_string_1476 lv_crlf_1476 wa_csv INTO lv_string_1476.
  CLEAR: wa_csv.
ENDLOOP.
*TRANSFER lv_string_396 TO lv_fullfile.
TRANSFER lv_string_1476 TO lv_fullfile.
    CONCATENATE 'File' lv_fullfile 'downloaded' INTO lv_msg SEPARATED BY space.
    MESSAGE lv_msg TYPE 'S'.
  ENDIF.
