...
DATA:  field1     TYPE c LENGTH 40 VALUE    'Material Number',
       ...
       field3     TYPE c LENGTH 40 VALUE    'Task list usage',
       field4     TYPE c LENGTH 40 VALUE    'Status',
       field5     TYPE c LENGTH 40 VALUE    'Activity Number',
       field6     TYPE c LENGTH 40 VALUE    'Work center',
       field7     TYPE c LENGTH 40 VALUE    'Control key',
       field8     TYPE c LENGTH 40 VALUE    'Operation short text',
       field9     TYPE c LENGTH 40 VALUE    'Description of standard value 1',
       field10    TYPE c LENGTH 40 VALUE    'Unit of Measurement of Standard Value'.
