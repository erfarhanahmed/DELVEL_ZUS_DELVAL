*&---------------------------------------------------------------------*
*& Report ZUS_PP_BOM_UPLOAD_EXCEL
*&---------------------------------------------------------------------*
*&
*&---------------------------------------------------------------------*
REPORT ZUS_PP_BOM_UPLOAD_EXCEL.
...
DATA:  field1     TYPE c LENGTH 40 VALUE    'Material Number',
       field2     TYPE c LENGTH 40 VALUE    'BOM Usage',
       field3     TYPE c LENGTH 40 VALUE    'BOM component',
       field4     TYPE c LENGTH 40 VALUE    'Item category',
       field5     TYPE c LENGTH 40 VALUE    'Component quantity',
       field6     TYPE c LENGTH 40 VALUE    'Issue location',
       field7     TYPE c LENGTH 40 VALUE    'Valid From Date',
       field8     TYPE c LENGTH 40 VALUE    'Plant'.


INCLUDE ZUS_BOM_UPLOAD_EXCEL_FORMAT.
...
* CREATE FIRST EXCEL SHEET
  ...
  CALL METHOD OF
    SHEET
    'ACTIVATE'.
  SET PROPERTY OF SHEET 'NAME' = 'BOM_UPLOAD'.
...
*************************************#*********
  CALL METHOD OF
    ...
    'SAVEAS'
    EXPORTING
      #1 = 'D:\SAP_DATA\BOM_UPLOAD.XLS'     "FILENAME
      #2 = 1.                          "FILEFORMAT
