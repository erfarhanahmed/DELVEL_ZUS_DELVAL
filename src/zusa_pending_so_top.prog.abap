...
TYPES:BEGIN OF ty_vbap,
        ...
        zbstkd      TYPE vbap-zbstkd,      """Added by Pranit 13.03.2024
        zposex      TYPE vbap-zposex,      """Added by Pranit 13.03.2024
        ernam       TYPE vbap-ernam,      """Added by Pranit 25.03.2024
        erdat       TYPE vbap-erdat,      """Added by Pranit 25.03.2024
...
TYPES : BEGIN OF output,
          ...
          canceldate   TYPE vbap-canceldate,
          deldate      TYPE vbap-deldate,
          zbstkd       TYPE vbap-zbstkd,    ""ADDed by Pranit 14.03.2024
          zposex       TYPE vbap-zposex,    ""ADDed by Pranit 14.03.2024
          ernam        TYPE vbap-ernam,    ""ADDed by Pranit 25.03.2024
          erdat1       TYPE vbap-erdat,    ""ADDed by Pranit 25.03.2024
          ld_txt1       TYPE char30,    ""ADDed by Pranit 14.03.2024
          tpi          TYPE char100,
          ...
          tag_no       TYPE c LENGTH 400,             "added by pankaj 18.01.2022
*
...
*          bzirk       TYPE knvv-bzirk,
          ship_from    TYPE char250,
          ofm_date_new TYPE char30,
          DELAYED_REMARK TYPE CHAR50,         ""Added by 11.04.2024
...
TYPES:
  BEGIN OF t_final,
    ...
    humc1        TYPE char20,
    spl_ins      TYPE char250,
    tag_no(400),             "added by pankaj 18.01.2022
    ship_from    TYPE char250,
    ofm_date_new TYPE char30,
    ZBSTKd       TYPE VBAP-zbstkd,      """Added by Pranit 13.03.2024
    zposex       TYPE VBAP-zposex,      """Added by Pranit 13.03.2024
    ld_txt1      TYPE char20,           """Added by Pranit 13.03.2024
    ernam        TYPE char15,           """Added by Pranit 25.03.2024
    erdat1       TYPE char11,           """Added by Pranit 25.03.2024
    delayed_remark TYPE char50,           """Added by Pranit 25.03.2024
    zmrp_delay     TYPE string,           """Added by Pranit 18.11.2024
  END OF t_final,
...
*      wa_tvzbt     TYPE t052u,     """Commented by pranit 16.03.2024
      wa_tvzbt     TYPE tvzbt,      """Changes by pranit 16.03.2024
