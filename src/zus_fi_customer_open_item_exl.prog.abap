*&---------------------------------------------------------------------*
*& Report ZUS_FI_CUSTOMER_OPEN_ITEM_EXL
*&---------------------------------------------------------------------*
*&
*&---------------------------------------------------------------------*
REPORT ZUS_FI_CUSTOMER_OPEN_ITEM_EXL.

INCLUDE ZUS_FI_CUSTOMER_EXCEL_FORMAT.
...
***START OF COLUMN NUMBERS
  ...
  WA_DATA-FIELD12 = 'Tax Code'.
  WA_DATA-FIELD13 = 'Baseline Date'.
  WA_DATA-FIELD14 = 'item text'.
...
* CREATE FIRST EXCEL SHEET
  ...
  CALL METHOD OF
    SHEET
    'ACTIVATE'.
  SET PROPERTY OF SHEET 'NAME' = 'Customer Open Item'.
...
*************************************#*********
  CALL METHOD OF
    ...
    'SAVEAS'
    EXPORTING
      #1 = 'D:\SAP_DATA\Customer Open Item.XLS'     "FILENAME
