*&---------------------------------------------------------------------*
*& Report ZUS_FI_VENDOR_OPEN_EXCEL
*&---------------------------------------------------------------------*
*&
*&---------------------------------------------------------------------*
REPORT ZUS_FI_VENDOR_OPEN_EXCEL.
...
INCLUDE ZUS_FI_VEN_OPEN_EXCEL_FORMAT.
...
*  WA_DATA-FIELD10 = 'GL Indicator'.
  WA_DATA-FIELD11 = 'Amount'.
  WA_DATA-FIELD12 = 'Bline Date'.
*  WA_DATA-FIELD13 = 'Business Place'.
*  WA_DATA-FIELD14 = 'Business Section'.
*  WA_DATA-FIELD15 = 'Due on'.
  WA_DATA-FIELD13 = 'Text1'.
  WA_DATA-FIELD14 = 'Posting Key'.
  WA_DATA-FIELD15 = 'Account'.
  WA_DATA-FIELD16 = 'Amount'.
*  WA_DATA-FIELD20 = 'Payt Terms'.
  WA_DATA-FIELD17 = 'Profit Center'.
*  WA_DATA-FIELD22 = 'Bline Date'.
  WA_DATA-FIELD18 = 'Text2'.
...
* CREATE FIRST EXCEL SHEET
  ...
  CALL METHOD OF
    SHEET
    'ACTIVATE'.
  SET PROPERTY OF SHEET 'NAME' = 'Vendor Open Item'.
...
*************************************#*********
  CALL METHOD OF
    ...
    'SAVEAS'
    EXPORTING
      #1 = 'D:\SAP_DATA\Vendor Open Item.XLS'     "FILENAME
