*&---------------------------------------------------------------------*
*& Report ZUS_FI_CUSTOMER_OPEN_ITEM
*&---------------------------------------------------------------------*
...
AT SELECTION-SCREEN.
  IF sscrfields-ucomm EQ 'BUT1' .
    SUBMIT ZUS_FI_CUSTOMER_OPEN_ITEM_EXL VIA SELECTION-SCREEN .
    ENDIF.
...
perform bdc_field       using 'BSEG-SGTXT'
                              itab-sgtxt.             "'Gl Open line item upload'.
perform bdc_field       using 'RF05A-NEWBS'
                              itab-newbs_new.            "'50'.
perform bdc_field       using 'RF05A-NEWKO'
                              itab-newko_new.           "'90002'.
...
perform bdc_field       using 'BSEG-WRBTR'
                              itab-wrbtr2.             "'100.00'.
perform bdc_field       using 'BSEG-SGTXT'
                              itab-sgtxt_new.           "'Gl Open line item upload'.
perform bdc_field       using 'DKACB-FMORE'
                              'X'.
perform bdc_dynpro      using 'SAPLKACB' '0002'.
perform bdc_field       using 'BDC_CURSOR'
...
********************************old bdc*****************
*if ITAB-NEWBS eq '01' AND ITAB-NEWUM IS INITIAL.
*perform bdc_dynpro      using 'SAPMF05A' '0100'.
*perform bdc_field       using 'BDC_CURSOR'
*                              'RF05A-NEWKO'.
*perform bdc_field       using 'BDC_OKCODE'
...
*                               itab-KURSF.               " '1'.
*perform bdc_field       using 'BKPF-XBLNR'
*                               itab-XBLNR.               "   'REF Cust 1'.
*perform bdc_field       using 'BKPF-BKTXT'
*                               itab-BKTXT.             "'Header Text Cust 1'.
*perform bdc_field       using 'FS006-DOCID'
*                              '*'.
*perform bdc_field       using 'RF05A-NEWBS'
*                                ITAB-NEWBS.              "'01'.
...
*                               itab-prctr.                " '1001'.
*
*ELSEIF ITAB-NEWBS eq '19' AND ITAB-NEWUM EQ 'A'.
*""""""""""""""""""""2 nd recording"""''''''''''''''''''''
*
*perform bdc_dynpro      using 'SAPMF05A' '0100'.
*perform bdc_field       using 'BDC_CURSOR'
...
*                                itab-KURSF.                   " '1'.
*perform bdc_field       using 'BKPF-XBLNR'
*                               itab-XBLNR.              "'REF Cust ADV'.
*perform bdc_field       using 'BKPF-BKTXT'
*                               itab-BKTXT.              "'Header Text CADV'.
*perform bdc_field       using 'FS006-DOCID'
*                              '*'.
*perform bdc_field       using 'RF05A-NEWBS'
*                                itab-NEWBS.                 "'19'.
...
*
*"""""""""********* 3 rd recording
*ELSEIF ITAB-NEWBS eq '11' AND ITAB-NEWUM is INITIAL.
*
*perform bdc_dynpro      using 'SAPMF05A' '0100'.
*perform bdc_field       using 'BDC_CURSOR'
*                              'RF05A-NEWKO'.
...
*                               itab-KURSF.                        " '1'.
*perform bdc_field       using 'BKPF-XBLNR'
*                              itab-XBLNR.                        "'REF Cust Debit N'.
*perform bdc_field       using 'BKPF-BKTXT'
*                               itab-BKTXT.                      " 'Header Text Debit Note'.
*perform bdc_field       using 'FS006-DOCID'
*                              '*'.
*perform bdc_field       using 'RF05A-NEWBS'
*                               itab-NEWBS.                       " '11'.
