...
*        CONCATENATE WA_OUTPUT-ld_txt wa_lines-tdline  INTO LV_DATA SEPARATED BY space.
*      ENDIF.
*    ENDLOOP.
*
*     WA_OUTPUT-ld_txt   =  LV_DATA.
...
***      ENDIF.
  ...
  READ TABLE LT_VBFA INTO LS_VBFA WITH KEY VBELV = WA_VBAK-vbeln.

   IF SY-subrc = 0.

       wa_output-DELDATE = LS_VBFA-ERDAt.
...
*         WITH SY-MSGV1 SY-MSGV2 SY-MSGV3 SY-MSGV4.
      ...
      LOOP AT lv_lines INTO wa_lines.
      IF NOT wa_lines-tdline IS INITIAL..
        CONCATENATE WA_OUTPUT-ld_txt wa_lines-tdline  INTO wa_output-LD_TXT SEPARATED BY space.
      ENDIF.
    ENDLOOP.
*      WA_OUTPUT-ld_txt   =  LV_DATA.
