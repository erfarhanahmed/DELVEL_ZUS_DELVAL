  ...
  LOOP AT it_budat INTO wa_budat.
    ...
    LOOP AT it_bsad INTO wa_bsad WHERE budat EQ wa_budat-budat.
      ...
      ENDIF.
       ...
       IF wa_bsad-augdt >= wa_final-budat  AND wa_bsad-blart = 'DZ'.
         wa_final-cash_rec =   wa_final-cash_rec + wa_bsad-dmbtr.
       ENDIF.
...
***Added on 27.02.19
      ...
      IF  wa_bsad1-blart = 'DZ' AND  wa_bsad1-umskz IS INITIAL AND wa_bsad1-rebzg IS INITIAL.
        IF wa_bsad1-shkzg = 'S'.
          gv_dmbtr = wa_bsad1-dmbtr * -1.
        ELSE.
          gv_dmbtr = wa_bsad1-dmbtr .
        ENDIF.
        wa_final-cash_rec = wa_final-cash_rec + gv_dmbtr."wa_bsad1-dmbtr .
      ENDIF.
