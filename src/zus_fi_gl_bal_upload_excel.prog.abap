*&---------------------------------------------------------------------*
*& Report ZUS_FI_GL_BAL_UPLOAD_EXCEL
*&---------------------------------------------------------------------*
*&
*&---------------------------------------------------------------------*
REPORT ZUS_FI_GL_BAL_UPLOAD_EXCEL.
...
INCLUDE ZUS_FI_GL_BAL_EXCEL_FORMAT.
...
***START OF COLUMN NUMBERS
  ...
  WA_DATA-FIELD12 = 'Line Item Text1'.
  WA_DATA-FIELD13 = 'Posting Key'.
  WA_DATA-FIELD14 = 'Account'.
  WA_DATA-FIELD15 = 'Profit Center'.
  WA_DATA-FIELD16 = 'Amount'.
  WA_DATA-FIELD17 = 'Cost Center'.
  WA_DATA-FIELD18 = 'Line Item Text2'.
...
* CREATE FIRST EXCEL SHEET
  ...
  CALL METHOD OF
    SHEET
    'ACTIVATE'.
  SET PROPERTY OF SHEET 'NAME' = 'GL Balance Upload'.
...
*************************************#*********
  CALL METHOD OF
    ...
    'SAVEAS'
    EXPORTING
      #1 = 'D:\SAP_DATA\GL Balance Upload.XLS'     "FILENAME
