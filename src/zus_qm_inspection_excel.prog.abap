*&---------------------------------------------------------------------*
*& Report ZUS_QM_INSPECTION_EXCEL
*&---------------------------------------------------------------------*
*&
*&---------------------------------------------------------------------*
REPORT ZUS_QM_INSPECTION_EXCEL.
...
DATA:  field1     TYPE c LENGTH 40 VALUE    'Material Number',
       ...
       field5     TYPE c LENGTH 40 VALUE    'Control Key'.



INCLUDE ZUS_INSP_EXCEL_FORMAT.
...
* CREATE FIRST EXCEL SHEET
  ...
  CALL METHOD OF
    SHEET
    'ACTIVATE'.
  SET PROPERTY OF SHEET 'NAME' = 'INSPECTION_PLAN'.
...
*************************************#*********
  CALL METHOD OF
    ...
    'SAVEAS'
    EXPORTING
      #1 = 'D:\SAP_DATA\INSPECTION_PLAN.XLS'     "FILENAME
      #2 = 1.                          "FILEFORMAT
