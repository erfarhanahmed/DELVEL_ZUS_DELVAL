...
FORM get_data .
  ...
  SELECT bukrs
         ...
         WHERE gjahr = p_year
           ...
           AND kstar IN ( '0000040000', '0000040010' ).
...
*         b~netwr
*         b~matnr
*         b~werks INTO TABLE it_vbrk_rp FROM vbrk AS a
*         INNER JOIN vbrp AS b ON b~vbeln = a~vbeln
**         WHERE a~fkdat BETWEEN low AND high "'20170101' AND '20171231'  ." p_year20170225
...
*DELETE it_vbrk_rp WHERE fkart EQ 'US08'.
  ...
  IF it_bseg IS NOT INITIAL.
    ...
    SELECT bukrs
           belnr
           gjahr
           monat FROM bkpf INTO TABLE it_bkpf
...
*            AND  kschl = 'ZPR0'.
  ...
  LOOP AT it_mara INTO wa_mara.
    ...
    LOOP AT it_bseg INTO wa_bseg WHERE matnr = wa_mara-matnr.
...
LOOP AT it_final INTO wa_final.
 ...
 wa_down-mar       =  wa_final-mar      .
 wa_down-apr       =  wa_final-apr      .
 wa_down-may       =  wa_final-may      .
 wa_down-jun       =  wa_final-jun      .
 wa_down-jul       =  wa_final-jul      .
 wa_down-aug       =  wa_final-aug      .
...
* wa_down-un_qty       =  wa_final-un_qty       .
 ...
 wa_down-sale_tot     =  wa_final-sale_tot     .
