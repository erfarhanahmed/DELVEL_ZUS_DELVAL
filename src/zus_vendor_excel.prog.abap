...
DATA:  field1     TYPE c LENGTH 40 VALUE    'Company Code',
       ...
       field6     TYPE c LENGTH 40 VALUE    'Search Term',
       field7     TYPE c LENGTH 40 VALUE    'Search Term 2',
       field8    TYPE  c LENGTH 40 VALUE    'STREET & House no',
       ...
       field16    TYPE c LENGTH 40 VALUE    'Language Key',
       field17    TYPE c LENGTH 40 VALUE    'Telephone No.',
       field18    TYPE c LENGTH 40 VALUE    'Mobile Number',
       field19    TYPE c LENGTH 40 VALUE    'Fax no',
       field20    TYPE c LENGTH 40 VALUE    'E-Mail Address',
       field21    TYPE c LENGTH 40 VALUE 'Reconciliation Account in General Ledger',
       field22    TYPE c LENGTH 40 VALUE 'Terms of Payment Key',
       field23    TYPE c LENGTH 40 VALUE 'Purchase order currency',
       field24    TYPE c LENGTH 40 VALUE 'Incoterms',
       field25    TYPE c LENGTH 40 VALUE 'Incoterms Desc',
       field26    TYPE c LENGTH 40 VALUE 'Group for Calculation Schema',
       field27    TYPE c LENGTH 40 VALUE 'Responsible Salesperson at Vendor Office',
       field28    TYPE c LENGTH 40 VALUE 'Vendor telephone number',
       field29    TYPE c LENGTH 40 VALUE 'Indicator: GR-Based Invoice Verification',
       field30    TYPE c LENGTH 40 VALUE 'Indicator for Service-Based Invoice Verification'.
